...
// New instantiates HTTP handlers for all the accountDex service endpoints
...
func (s *Server) Service() string { return "accountDex" }
...
func (s *Server) MethodNames() []string { return accountdex.MethodNames[:] }
...
// MountWalletInfoHandler configures the mux to serve the "accountDex" service
// "walletInfo" endpoint.
func MountWalletInfoHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/lpnode/lpnode_admin_panel/account/dex/walletInfo", f)
}

// NewWalletInfoHandler creates a HTTP handler which loads the HTTP request and
// calls the "accountDex" service "walletInfo" endpoint.
